    ...
    egui::Window::new("Help")
        ...
        .show(ctx, |ui| {
            egui::ScrollArea::vertical().show(ui, |ui| {
                ...
                ui.label("Tab          Next tab (Shift+Tab previous)");
                ui.label("1 / 2 / 3    Projects / Add files / Restore");
                ui.label("F1 / ?       Show or close this help (Shift+/ for ?)");
                ui.label("Shift+1      About (same physical key as !)");
                ui.label("v            View file—Projects row, Add file, or Restore › Files");
                ui.label("q            Quit");
                ui.add_space(10.0);
                ...
                ui.label("Home/End     Jump to start/end of list");
                ui.add_space(10.0);
                ...
                ui.label("m            Toggle track mode (Git → Backup → Both)");
                ui.label("x / Shift+x  Encrypt toggle: file / entire project");
                ui.label("a            Incremental backup (message prompt)");
                ui.label("Shift+a      Silent incremental backup");
                ui.label("b            Archive backup (config default_archive_format)");
                ui.label("s            Sync project (mark synced in index)");
                ui.label("Shift+S      Save manifest + index if dirty");
                ui.label("g            Refresh git remote status");
                ui.label("Shift+G      Set git remote URL");
                ui.label("p / Shift+p  Push / Pull");
                ui.label("n            New project");
                ui.label("Shift+D      Delete project");
                ui.label("r            Rescan projects and file statuses");
                ui.add_space(10.0);
                ...
                ui.label("` (backtick) Go to home directory");
                ui.label("a            Add selected file");
                ui.label("u            Untrack file");
                ui.label("t            Cycle track mode");
                ui.label("p            Cycle target project");
                ui.label("n            New project");
                ui.label("Shift+R      Recursive add preview");
                ui.add_space(10.0);

                ui.label(RichText::new("Restore Tab").color(Colors::YELLOW).strong());
                ui.label("Enter/→/l    Drill in / confirm");
                ui.label("←/h/Bksp     Back one level");
                ui.label("(Files view)");
                ui.label("Space        Toggle selection");
                ui.label("a / d        Select all / none");
                ui.label("Enter or R   Open restore confirmation");
                ui.label("v            View selected local file when it exists");
                ui.add_space(10.0);
    ...
    egui::Window::new("About Dot Matrix")
        ...
        .show(ctx, |ui| {
            ui.vertical_centered(|ui| {
                ...
                ui.label("Dot Matrix tracks, versions, and backs them up.");
                ui.add_space(20.0);
